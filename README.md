...
| Project | Stars | Description | 适合阶段 |
|---|---|---|---|
| [LangChain](https://github.com/langchain-ai/langchain) | 100k+ | The original LLM application framework with extensive integrations. | Beginner+ |
...
| [Pydantic AI](https://github.com/pydantic/pydantic-ai) | 10k+ | Agent framework built on Pydantic with type-safe tool definitions. | Beginner+ |
...
- **TypeScript?** Mastra — first-class TS support with built-in observability
...
Core SDKs for connecting to LLM providers.

连接大模型服务商的核心 SDK。

| Project | Description | Key Models |
|---|---|---|
| [Anthropic SDK](https://github.com/anthropics/anthropic-sdk-python) | Official Claude API client. Tool use, streaming, batching. | Claude 4, Claude 3.5 |
| [OpenAI SDK](https://github.com/openai/openai-python) | Official GPT/o-series API client. Function calling, assistants. | GPT-4o, o3, o4-mini |
| [Google GenAI SDK](https://github.com/googleapis/python-genai) | Official Gemini API client. Multimodal, grounding, code exec. | Gemini 2.5 Pro/Flash |
| [AWS Bedrock SDK](https://docs.aws.amazon.com/bedrock/) | Managed access to Claude, Llama, Mistral and more. | Multi-provider |
| [Ollama](https://github.com/ollama/ollama) | Run LLMs locally. Easy setup for macOS/Windows/Linux. | Llama 3, Mistral, Phi |
| [LiteLLM](https://github.com/BerriAI/litellm) | Unified API for 100+ LLM providers. Proxy, load balancing, cost tracking. | All providers |
| [AI SDK (Vercel)](https://github.com/vercel/ai) | TypeScript SDK for streaming AI responses in web apps. | Multi-provider |
